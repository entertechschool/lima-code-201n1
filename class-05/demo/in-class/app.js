...
function multiplyAnyArray(dynamicArray) {
  ...
  for (let i = 0; i < dynamicArray.length; i++) {
    let resultMultiply = multiply(product, dynamicArray[i]);
    // resultMultiply = [2, 'The product of 1 and 2 is 2'];
    product = resultMultiply[0];
  }

  let joinedElementsOfArray = dynamicArray.join(",");
  console.log("joinedElementsOfArray: ", joinedElementsOfArray);

  return [
    product,
    `The numbers ${joinedElementsOfArray} have a product of ${product}.`,
  ];
}
